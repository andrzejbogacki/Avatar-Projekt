...
- **Historia zmian:**
  ...
  - 2026-07-12 — kontrakt rozszerzony o `wczytajProfil(avatar_id)` (odczyt zapisanego profilu dla klientów QAC — Rezonator, ADR-005); `regulator9` eksportuje `KATALOG_PROFILI`. Bez zmian logiki obliczeniowej.
